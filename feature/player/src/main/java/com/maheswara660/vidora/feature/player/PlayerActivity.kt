...
import com.maheswara660.vidora.core.common.extensions.getMediaContentUri
import com.maheswara660.vidora.core.ui.theme.VidoraTheme
import com.maheswara660.vidora.feature.player.extensions.registerForSuspendActivityResult
...
import com.maheswara660.vidora.feature.player.service.PlayerService
import com.maheswara660.vidora.feature.player.service.addSubtitleTrack
import com.maheswara660.vidora.feature.player.service.stopPlayerSession
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CompositionLocalProvider(LocalUseMaterialYouControls provides (uiState.playerPreferences?.useMaterialYouControls == true)) {
                VidoraTheme(darkTheme = true) {
                    MediaPlayerScreen(
                        player = player,
                        viewModel = viewModel,
                        playerPreferences = uiState.playerPreferences ?: return@VidoraTheme,
