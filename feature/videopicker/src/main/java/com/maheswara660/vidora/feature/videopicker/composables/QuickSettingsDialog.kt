...
import com.maheswara660.vidora.feature.videopicker.extensions.name
            ...
            SingleChoiceSegmentedButtonRow(
                ...
                Sort.Order.entries.forEachIndexed { index, sortOrder ->
                    SegmentedButton(
                        ...
                        icon = {
                            Icon(
                                imageVector = if (sortOrder == Sort.Order.ASCENDING) VidoraIcons.ArrowUpward else VidoraIcons.ArrowDownward,
...
fun FieldChip(
    ...
    selectedIcon: ImageVector = VidoraIcons.CheckBox,
    unselectedIcon: ImageVector = VidoraIcons.CheckBoxOutline,
) {
    FilterChip(
        selected = selected,
        onClick = onClick,
