package com.maheswara660.vidora.settings.screens.gesture
...
import com.maheswara660.vidora.core.common.extensions.round
import com.maheswara660.vidora.core.common.extensions.toString
...
private fun GesturePreferencesContent(
    ...
    Scaffold(
        topBar = {
            VidoraTopAppBar(
                title = stringResource(id = R.string.gestures_name),
                centered = true,
                navigationIcon = {
        ...
        Column(
            ...
            Column(
                ...
                PreferenceSwitch(
                    ...
                    icon = VidoraIcons.SwipeHorizontal,
                ...
                PreferenceSwitch(
                    ...
                    icon = VidoraIcons.SwipeVertical,
                ...
                PreferenceSlider(
                    ...
                    trailingContent = {
                        IconButton(onClick = { onEvent(GesturePreferencesUiEvent.UpdateSeekIncrement(PlayerPreferences.DEFAULT_SEEK_INCREMENT)) }) {
                            Icon(
                                imageVector = VidoraIcons.History,
