...
fun VidoraDialog(
    ...
    dialogProperties: DialogProperties = VidoraDialogDefaults.dialogProperties,
) {
    ...
    AlertDialog(
        ...
        text = { Column { content() } },
        modifier = modifier
            .widthIn(max = configuration.screenWidthDp.dp - VidoraDialogDefaults.dialogMargin * 2),
...
@Composable
fun VidoraDialogWithDoneAndCancelButtons(
    title: String,
    onDoneClick: () -> Unit,
    onDismissClick: () -> Unit,
    content: @Composable () -> Unit,
